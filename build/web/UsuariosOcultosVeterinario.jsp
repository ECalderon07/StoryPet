...
<html>
    ...
    <body>
        <div class="container">
            <h1 class="text-center">Lista Veterinarios.!</h1><br>
            <%
                Conexion conexion = new Conexion();
                Statement puente;
                ResultSet rs;
                puente = conexion.obtenerConexion().createStatement();
                rs = puente.executeQuery("select idUsuario,Usuario,Nombres,Apellidos,Telefono,Correo,Rol from usuarios where Rol='veterinario' and Estado=0;");
            %>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a class="btn btn-primary" href="Veterinario?accion=EstadoVetActivar&id=<%= rs.getString("idUsuario")%>&Estado=1">Activar</a>
                            </td>
                        </tr>
                        <%
                            }
