                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a class="btn btn-warning btnEditarH" data-id="<%= rs.getString("historialclinico.idHistorialClinico")%>"><i class="fa fa-pencil"></i> Editar</a>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="Veterinario" method="POST" class="text-center" id="formRegistrarHistorial" >
                            ...
                            <input class="bordes" placeholder="Cedula" readonly="" type="number" value="<%= cedula %>" name="IdUsuario">
                            <br> <br> 
                            <input id="btnRegistrar" class="btn btn-outline-primary" type="submit" name="accion" value="RegistrarH">
                        </form>
                    </div>
