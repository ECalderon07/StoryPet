    ...
    <body class="nav-md">
        <div class="container body">
                    ...
                    <div class="left_col scroll-view">
                        ...
                        <div class="profile clearfix">
                            <div class="profile_pic">
                                <img src="images/veterinarian.png" alt="..." class="img-circle profile_img">
                            </div>
                        ...
                        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                            <div class="menu_section">
                                ...
                                <ul class="nav side-menu">
                                    ...
                                    <li><a id="btnCorreos"><i class="fa fa-bar-chart-o"></i> Correos</a>
                                    </li>      
                                </ul>
                            </div>
                        </div>
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <li class="">
                                    <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                        <img src="images/veterinarian.png" alt=""><%= nombre%>
                                        <span class=" fa fa-angle-down"></span>
                                    </a>
                                    <ul class="dropdown-menu dropdown-usermenu pull-right">
                                        <li><a id="btnPerfil"> Perfil</a></li>
                                        <li><a id="btnConfiguracion">Configuracion</a></li>
                                </li>
            ...
            <script>
                ...
                $(document).ready(function () {
                    ...
                    $("#btninhabilitados").click(function () {
                        $.ajax({
                            url: 'Usuario',
                            method: 'POST',
                            data: {'accion': 'listarInhabilitados'},
                            success: function (respuesta) {
                                $("#contenido_principal").html(respuesta)
                            },
                            error: function () {
                ...
                $("#btnCorreos").click(function () {
                    alert("entrar correos")
                    $.ajax({
                        url: 'Usuario',
                        method: 'POST',
                        data: {'accion': 'CorreoVista'},
                        success: function (respuesta) {
                            $("#contenido_principal").html(respuesta)
                        },
                        error: function () {
