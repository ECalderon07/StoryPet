    ...
    <body>
        <div class="container">   
            <div class="col-lg-6">
                ...
                %>
                <form action="Veterinario" method="POST" id="formActualizarUsuario">
                    ...
                    <input id="btnActualizar" class="btn btn-primary" type="submit" name="accion" value="ActualizarVeterinario">
                </form>
            </div>
        </div>                    
