...
<html>
    ...
    <body>
        ...
        <div class="container text-center">
            ...
            <form action="Veterinario" method="POST" id="formActualizarHisto">
                ...
                <input id="btnActualizarHisto" class="btn btn-success" type="submit" name="accion" value="ActualizarH"> <br><br>
            </form> 
        </div>
